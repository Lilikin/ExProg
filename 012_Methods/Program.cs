...
//         for (int j = i + 1; j < array.Length; j++)              //ищет 
//         {                                                       //минимальный       
//             if(array[j] < array[minPosition]) minPosition = j;  //элемент
//         }                                                       //
...
void SelectionSort(int[] array)
{
    ...
    for (int i = 0; i < array.Length - 1; i++)
    {
        ...
        for (int j = i + 1; j < array.Length; j++)              //ищет 
        {                                                       //максимальный       
            if(array[j] > array[maxPosition]) maxPosition = j;  //элемент
        }                                                       //
